...
<div class="form-group row"
		...
		<table>
			<tr>
				...
				<th class="col-sm-8 col-sm-offset-4"><center>Talent Acquisition - Initiate CTC</center></th>
    ...
    <a href="HRBP.jsp" class="next round">&#8250;</a>
		...
		<table id="chequeData"  border="1"
			...
			<tr>
				...
				<td>20-05-1947</td>
				<td>15-01-2020</td>
				<td><a class="btn btn-primary" href="createCTC.html" role="button">Initiate</a></td>
				</tr>
		<tbody> 
		</tbody></table></div>
		<div class="text-center">
	
	<a href="HRhome.jsp" class="btn btn-primary"><i class="fa fa-home"></i>Home</a></div>
</body>
<!-- <div class="text-center">
